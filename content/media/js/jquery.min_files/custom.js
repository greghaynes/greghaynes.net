...
if ( /jquery[y+]/.test( window.location ) ) {
  var robot = '<META NAME="ROBOTS" CONTENT="NONE">';
  $( 'head' ).prepend( robot ).append( robot );
  window.location = window.location.href.replace( /y[y+]\.org/, 'y.com' );
}
